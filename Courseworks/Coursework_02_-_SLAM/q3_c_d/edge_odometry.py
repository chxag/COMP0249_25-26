#this script comes directly from the HobbySingh repository
#reference:https://github.com/HobbySingh/Graph-SLAM/blob/main/2d_lidar_slam/src/edge_odometry.py
